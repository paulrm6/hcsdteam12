...
public class Appointment {
    ...
    public int retrieveStartDay() { return startDay; }
    public int retrieveStartMonth() { return startMonth; }
    public int retrieveStartYear() { return startYear; }
    public int retrieveDuration() { return duration; }
    
    public String retrievePatientName() { return name; }
